...
badd +1 makefile
badd +0 src/darray_algos.h
badd +0 src/darray_algos.c
badd +0 tests/tests_algos.c
argglobal
silent! argdel *
argadd src/darray.h
set stal=2
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 112 - ((21 * winheight(0) + 29) / 58)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
112
normal! 0
tabedit tests/tests_algos.c
set splitbelow splitright
set nosplitbelow
set nosplitright
wincmd t
